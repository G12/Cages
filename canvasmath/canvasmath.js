...
var LText = {
    ...
    box: function () {
        ...
        font.push(style.family || "arial");//"serif");
        this.font = font.join(" ");
...
var FixedChildrenExpression = {
    ...
    removeChild: function (child) {
        ...
        if (self.optionalProperties[prop]) {
            ...
            //TODO this line commented out to remove error at EditExpr()
...
var expr = cvm.expr = {
	...
	drawOnExternalCanvas: function(e, ctx, x, y)
	{
		var box = cvm.layout.ofExpr(e).box();
        e.box = box;
        box.drawOnCanvas(ctx, x, box.ascent + y);
	},
